...
- 落稿策略固定为“先侧写 working draft，再并回正式骨架”；第4章唯一工作草稿固定为 `<your-thesis-repo>/thesis/chapter4-working-draft.md`。
...
- 已满足：
  - 第4章实验素材包 V2 已完成三层重组。
  - `<your-thesis-repo>/thesis/paper-evidence-map.md` 中第4章边界已经稳定。
  - `<your-thesis-repo>/thesis/paper-writing-log.md` 已明确 `T-010` 默认只读 `README.md + 前半写作层/`。
  - `<your-thesis-repo>/thesis/document.tex` 中已有第4章骨架。
...
- 第4章素材包前半写作层：
  - `<reference-materials>/第四章实验环境与参数卡.md`
  - `<reference-materials>/第四章数据集概览卡.md`
  - `<reference-materials>/第四章baseline设计卡.md`
  - `<reference-materials>/第四章单变量实验设计卡.md`
  - `<reference-materials>/第四章前半图表建议清单.md`
- 目标正文：
...
- 用 `$doc-coauthoring` 创建 `<your-thesis-repo>/thesis/chapter4-working-draft.md`。
- 先固定前半部分四个小节骨架：
  - `4.1 实验环境与参数设置`
  - `4.2 数据集介绍`
  - `4.3 基线实验设计`
...
### 阶段 B：按小节顺序推进
- 不跳序推进，保持与 `<your-thesis-repo>/thesis/paper-writing-log.md`、`<your-thesis-repo>/thesis/document.tex` 和后续日志同步一致。
...
### 阶段 E：并回与编译
- `4.1 -> 4.4` 稳定后，允许先并回 `<your-thesis-repo>/thesis/document.tex`。
- 并回时仅更新前半部分，`4.5 / 4.6` 继续保留占位，等待 `T-011`。
- 编译只在前半章已经并回 `<your-thesis-repo>/thesis/document.tex` 后执行。
...
- <your-thesis-repo>\文档\参考文献\第四章实验素材包\前半写作层\第四章实验环境与参数卡.md
- <your-thesis-repo>\文档\参考文献\第四章实验素材包\前半写作层\第四章数据集概览卡.md
- <your-thesis-repo>\文档\参考文献\第四章实验素材包\前半写作层\第四章baseline设计卡.md
- <your-thesis-repo>\文档\参考文献\第四章实验素材包\前半写作层\第四章单变量实验设计卡.md
- <your-thesis-repo>\文档\参考文献\第四章实验素材包\前半写作层\第四章前半图表建议清单.md
- <your-thesis-repo>\thesis\chapter4-working-draft.md
- <your-thesis-repo>\thesis\document.tex
- <your-thesis-repo>\thesis\document.bib

Task:
创建并维护 `<your-thesis-repo>\thesis\chapter4-working-draft.md`，按 `4.1 -> 4.2 -> 4.3 -> 4.4` 的顺序共写第4章前半部分。
...
## 编译规则
- 只有在第4章前半部分已经并回 `<your-thesis-repo>/thesis/document.tex` 后，才执行编译。
- 编译 recipe：
...
- `PLAN4.md` 已写死唯一 working draft 为 `<your-thesis-repo>/thesis/chapter4-working-draft.md`。
- `PLAN4.md` 已写死 `4.1 -> 4.4` 稳定后允许先并回 `<your-thesis-repo>/thesis/document.tex`。
- `PLAN4.md` 已区分 `T-010` 的 slice-end reviewer 诊断与 `T-011` 的正式 chapter-end reader testing。
- `PLAN4.md` 已写死编译方式为 `<your-thesis-repo>/.vscode/settings.json` 中的 `latexmk (xelatex)`，输出到 `thesis/build/`。
