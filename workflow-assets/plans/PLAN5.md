...
- 落稿策略固定为“先侧写 working draft，再并回正式骨架”；第5章唯一工作草稿固定为 `<your-thesis-repo>/thesis/chapter5-working-draft.md`。
...
- 已满足：
  ...
  - `<your-thesis-repo>/thesis/paper-evidence-map.md` 中第5章边界与素材入口已经稳定。
  - `<your-thesis-repo>/thesis/paper-writing-log.md` 已明确 `T-012A` 与 `T-013A` 下的第5章 authority 切换。
  - `<your-thesis-repo>/thesis/document.tex` 与 `<your-thesis-repo>/thesis/chapter5-working-draft.md` 可作为当前正文入口。
...
- 第5章素材包正文可写层：
  - `<reference-materials>/第五章写作总纲.md`
  - `<reference-materials>/第五章总结要点卡.md`
  - `<reference-materials>/第五章展望边界卡.md`
  - `<reference-materials>/第五章章节承接卡.md`
  - `<reference-materials>/摘要联动提示卡.md`
- 目标正文：
  - `<your-thesis-repo>/thesis/chapter5-working-draft.md`
...
- 用 `$doc-coauthoring` 创建 `<your-thesis-repo>/thesis/chapter5-working-draft.md`。
- 先固定第5章骨架：
  - `# 第5章 总结与展望`
  - `## 5.1 全文总结`
  - `## 5.2 研究展望`
...
3. 若该段存在以下问题，再调用 `$graduation-thesis-editor`：
   ...
   - 把总结写成新的结果章节
   - 把未来工作写成既成事实
4. 段落通过后继续下一段，不立刻并回 `<your-thesis-repo>/thesis/document.tex`。
...
### 阶段 E：并回与编译
- 第5章稳定后，将其并回 `<your-thesis-repo>/thesis/document.tex`。
- 并回时只更新第5章正文，不同时处理摘要。
- 编译只在第5章已并回 `<your-thesis-repo>/thesis/document.tex` 后执行。
...
Read first:
- <your-thesis-repo>\文档\参考文献\写作计划\PLAN5.md
...
- <your-thesis-repo>\文档\参考文献\第五章总结素材包\README.md
- <your-thesis-repo>\文档\参考文献\第五章总结素材包\正文可写层\第五章写作总纲.md
- <your-thesis-repo>\文档\参考文献\第五章总结素材包\正文可写层\第五章总结要点卡.md
- <your-thesis-repo>\文档\参考文献\第五章总结素材包\正文可写层\第五章展望边界卡.md
- <your-thesis-repo>\文档\参考文献\第五章总结素材包\正文可写层\第五章章节承接卡.md
- <your-thesis-repo>\thesis\chapter5-working-draft.md
- <your-thesis-repo>\thesis\document.tex
- <your-thesis-repo>\thesis\document.bib

Task:
创建并维护 `<your-thesis-repo>\thesis\chapter5-working-draft.md`，按固定顺序完成第5章 `5.1 全文总结` 与 `5.2 研究展望`。
...
## 编译规则
- 只有在第5章已经并回 `<your-thesis-repo>/thesis/document.tex` 后，才执行编译。
- 编译 recipe：
...
- `PLAN5.md` 已写死第5章唯一 working draft 为 `<your-thesis-repo>/thesis/chapter5-working-draft.md`。
- `PLAN5.md` 已区分：
  - `5.1` 只写全文总结
  - `5.2` 只写研究展望
- `PLAN5.md` 已明确区分：
  ...
  - 全文 reader testing
- `<your-thesis-repo>/thesis/paper-writing-log.md` 更新后，后续执行者不需要再临场决定：
  - 第5章是否仍是单节
