...
- 落稿策略固定为“先侧写 abstract working draft，再并回前置页模板”；摘要工作草稿固定为 `<your-thesis-repo>\thesis\abstract-working-draft.md`。
...
- 为避免把摘要写成“凭印象复述”，本计划同时固定读取：
  - `<your-thesis-repo>\文档\参考文献\第五章总结素材包\`
  - `<your-thesis-repo>\文档\参考文献\摘要素材包\`
- `<your-thesis-repo>\文档\如何写论文之摘要篇.pdf` 的核心规则已被吸收进本计划与摘要素材包，后续默认以更新后的 `PLAN6.md + 摘要素材包` 为 authority，不再回退到旧轻量入口。
...
- 已具备以下前置条件：
  ...
  - 第5章已按 `PLAN5.md` 完成关闭。
  - `<your-thesis-repo>\文档\参考文献\第五章总结素材包\` 已稳定。
  - `<your-thesis-repo>\文档\参考文献\摘要素材包\` 已建立。
  - `<your-thesis-repo>\thesis\cover.tex` 已提供摘要与关键词入口。
...
- 第5章素材包：
  ...
  - `<your-thesis-repo>\文档\参考文献\第五章总结素材包\正文可写层\摘要联动提示卡.md`
- 摘要素材包：
  - `<your-thesis-repo>\文档\参考文献\摘要素材包\README.md`
  - `<your-thesis-repo>\文档\参考文献\摘要素材包\摘要结构与结果句规则卡.md`
  - `<your-thesis-repo>\文档\参考文献\摘要素材包\摘要事实边界卡.md`
  - `<your-thesis-repo>\文档\参考文献\摘要素材包\摘要压缩顺序卡.md`
  - `<your-thesis-repo>\文档\参考文献\摘要素材包\摘要关键词与中英对齐卡.md`
- 目标正文文件：
  - `<your-thesis-repo>\thesis\abstract-working-draft.md`
...
- 用主流程 skill 维护 `<your-thesis-repo>\thesis\abstract-working-draft.md`。
- 先固定骨架：
  - `## 中文摘要`
  - `## 中文关键词`
  - `## English Abstract`
...
### 阶段 F：并回与编译
- 摘要稳定后，并回 `<your-thesis-repo>\thesis\cover.tex`。
...
Read first:
- <your-thesis-repo>\文档\参考文献\写作计划\PLAN6.md
- <your-thesis-repo>\thesis\paper-outline.md
- <your-thesis-repo>\thesis\paper-evidence-map.md
- <your-thesis-repo>\thesis\paper-writing-log.md
- <your-thesis-repo>\文档\参考文献\第五章总结素材包\README.md
