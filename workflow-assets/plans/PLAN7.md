...
- 当前阶段已经不是章节起草期：
  - 第1章到第5章正文已完成并并回 `<private-thesis-repo>/thesis/document.tex`
  - 中英文摘要已稳定并回 `<private-thesis-repo>/thesis/cover.tex`
...
## 启动前提
- 已具备以下前置条件：
  - `<private-thesis-repo>/thesis/paper-outline.md`、`<private-thesis-repo>/thesis/paper-evidence-map.md`、`<private-thesis-repo>/thesis/paper-writing-log.md` 已同步到“前五章与摘要已完成”的阶段。
  - `<private-thesis-repo>/thesis/document.tex`、`<private-thesis-repo>/thesis/cover.tex`、`<private-thesis-repo>/thesis/document.bib` 已构成当前正式稿入口。
  - [PLAN1.md](PLAN1.md) 到 [PLAN6.md](PLAN6.md) 及对应素材包已稳定，可作为局部回读 authority。
  - 当前模板编译入口与输出路径已固定在 `<private-reference>/.vscode/settings.json` 与 `thesis/build/`。
- 若以下条件不满足，则不要直接执行本计划：
  - 章节边界再次发生实质变化
  - 数据集角色口径再次摇摆
  ...
  - 模板入口或编译配置失效
- `T-013A` 的额外硬前提：
  - 若要改第3章图与正文，先回读 [PLAN3.md](PLAN3.md) + `第三章方法素材包/`
  - 若要改第4章图与正文，先回读 [PLAN4.md](PLAN4.md) / [PLAN4p.md](PLAN4p.md) + `第四章实验素材包/`
  - 若要改第5章正文，先回读 [PLAN5.md](PLAN5.md) + `第五章总结素材包/`
  - 若要改摘要，先回读 [PLAN6.md](PLAN6.md) + `摘要素材包/`
...
- 正式稿入口：
  ...
  - `<private-thesis-repo>/thesis/cover.tex`
...
### B. 章节级问题分流 authority
- 若问题定位到第1章：
  - 强制补读 [PLAN1.md](PLAN1.md) + `第一章引言素材包/`
- 若问题定位到第2章：
  - 强制补读 [PLAN2.md](PLAN2.md) + `第二章文献素材包/`
- 若问题定位到第3章：
  - 强制补读 [PLAN3.md](PLAN3.md) + `第三章方法素材包/`
- 若问题定位到第4章前半：
  - 强制补读 [PLAN4.md](PLAN4.md) + `第四章实验素材包/前半写作层/`
- 若问题定位到第4章结果或本章小结：
  - 强制补读 [PLAN4p.md](PLAN4p.md) + `第四章实验素材包/结果分析层/`
- 若问题定位到第5章：
  - 强制补读 [PLAN5.md](PLAN5.md) + `第五章总结素材包/正文可写层/`
- 若问题定位到摘要：
  - 强制补读 [PLAN6.md](PLAN6.md) + `摘要素材包/`
...
## 模板与编译收口规则
- 核心样式文件 `<private-thesis-repo>/thesis/jluthesisUTF8.sty` 不作为本轮常规修改目标。
- 模板目录结构不再随意调整。
- 但 `T-013A` 允许在当前本地模板 authority 下，对 `<private-thesis-repo>/thesis/jluthesisUTF8.sty`、`<private-thesis-repo>/thesis/cover.tex` 与 `<private-thesis-repo>/thesis/document.tex` 做安全、可回溯的格式收口，以解决字体、书签、页眉页脚、目录字符串与图表版式问题。
...
- 若本轮改变了某一章的可写边界、证据入口或收口规则，再同步：
  - `<private-thesis-repo>/thesis/paper-evidence-map.md`
  - 必要时同步 `<private-thesis-repo>/thesis/paper-outline.md`
